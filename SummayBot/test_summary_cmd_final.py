#!/usr/bin/env python3
"""
Script test lệnh summary từ command line - Final version
"""
...
def test_summary_cmd(chat_id, hours=24):
...
def main():
    """Main function"""
    if len(sys.argv) < 2:
        print("Usage: python test_summary_cmd_final.py <chat_id> [hours]")
        print("Examples:")
        print("  python test_summary_cmd_final.py -1002385574544")
        print("  python test_summary_cmd_final.py -1002385574544 1")
        print("  python test_summary_cmd_final.py -1002385574544 24")
        print("  python test_summary_cmd_final.py -1002385574544 48")
        return
    ...
    # Test summary
    count = test_summary_cmd(chat_id, hours)

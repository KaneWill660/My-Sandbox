#!/usr/bin/env python3
"""
Script import chat history với options: clear data cũ hoặc giữ nguyên
"""
...
def import_history(json_file_path, target_chat_id, clear_old=False):
    ...
    print("IMPORT CHAT HISTORY WITH OPTIONS")
    print("=" * 50)
...
def get_user_choice():
    ...
    print("CHON OPTION IMPORT:")
    print("1. Clear het data cu cua group nay")
    print("2. Giu nguyen data cu (chi them moi)")
    print()

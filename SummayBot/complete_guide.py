#!/usr/bin/env python3
"""
Hướng dẫn hoàn chỉnh export chat history và import vào database
"""

def complete_guide():
    """Hướng dẫn hoàn chỉnh export chat history và import vào database"""
    
    print("HUONG DAN HOAN CHINH - EXPORT CHAT HISTORY VA IMPORT")
    print("=" * 70)
    
    print("TOM TAT:")
    print("-" * 30)
    print("+ Bot API khong the doc tin nhan lich su")
    print("+ Can export chat history tu Telegram Desktop")
    print("+ Import vao database de bot co the doc")
    ...
    print("3. Luu file")
    print("4. Chat ID co the tim thay trong file JSON")
    ...
    print("-" * 40)
    print("+ Bot se hien thi keo tu tin nhan lich su")
    print("+ Bot se tu dong doc tin nhan moi")
    print("+ Bot se ket hop du lieu cu va moi")
    print("+ Bot se phan biet group")
    print("+ Bot se tu dong xoa tin nhan sau 1 phut")
    ...
    print("+ Chay demo_import.py de test truoc")
